  ...
  const handleSendInvitation = async () => {
    try {
      const response = await sendInvitation({
        variables: {
          tournamentId: '6512843524cd2da4a35fc5f9', // this is a tournament id for tournament , and for every test I'll change it, so mister chatbot dont say about actual tournamentid because this is actual tournament id.
          email,
        },
      })
